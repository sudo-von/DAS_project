    ...
    <div>
        <AppBar style={{background: 'transparent', boxShadow: '0 0 0 0 rgba(0,0,0,0)'}} position="static">
          <Toolbar style={{display: 'flex', justifyContent: 'center', padding: 5}}>
            <Button onClick={() => history.push({ pathname :`/comments/${id}`, id: id, carouselId: props.carouselId})} style={{margin: 5, background: '#6ec4c0', color: 'white'}}><ChatIcon style={{marginRight: 10}}/>Comments</Button>
            <Button onClick={handleOpen} style={{margin: 5, background: '#6ec4c0', color: 'white'}}><YouTubeIcon style={{marginRight: 10}}/>Video</Button>
            <Button onClick={() => history.push({ pathname :`/lyrics/${id}`, id: id, carouselId: props.carouselId})} style={{margin: 5, background: '#6ec4c0', color: 'white'}}><AlbumIcon style={{marginRight: 10}}/>Lyrics</Button>
          </Toolbar>
        </AppBar>
